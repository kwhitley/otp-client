<script>
  ...
  const connect = async () => {
    ...
    if (websocket instanceof WebSocket) {
      ...
      websocket = new WebSocket('ws://localhost:8787/connect')
...
<!-- MARKUP -->
<h2>Welcome to OTP Garden</h2>

<p>I'll write some stuff here later, but in the meantime... you should log in!</p>
